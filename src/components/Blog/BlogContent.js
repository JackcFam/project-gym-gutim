...
function BlogContent(props) {
  return (
    <div>
  <section className="blog-details-hero set-bg" data-setbg="img/blog/blog-detail-hero.jpg">
            ...
            <div className="bd-pic">
              <div className="row">
                <div className="col-lg-6">
                  <img src="https://i.imgur.com/FUFiJT6.jpg" alt />
                </div>
                <div className="col-lg-6">
                  <img src="https://i.imgur.com/f9eqgXr.jpg" alt />
                </div>
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-lg-3">
                  <div className="ba-pic">
                    <img src="https://i.imgur.com/2FalOQK.jpg" alt />
                  </div>
                </div>
